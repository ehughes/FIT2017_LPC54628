...
int main(void)
{
	...
	*/
	   ...
	   */
	   ...
	   /*
	    * Start the Digital MIC. Fs is 32Khz
	    *
	    *
	    */
	   Init_DMIC();
	    ...
	    *
	    */
	   PRINTF("Demo 3 : Audio Spectrum Analyzer\r\n");

	   arm_rfft_fast_init_f32(&MyFFT,FFT_LEN);
		...
		while(1)
		{
			...
			/*
			 * Compute the FFT Power Spectrum using
			 * the ARM CMSIS DSP Linrary
			 *
			 */
			 ...
			 arm_cmplx_mag_squared_f32(FFT_OutBuffer, PowerSpectrum,BUFFER_SIZE/2);


			for(int i=0;i<FFT_LEN/2;i++)
			{
			 	 eGFX_DrawVline(&eGFX_BackBuffer, eGFX_PHYSICAL_SCREEN_SIZE_Y-1,
				 eGFX_PHYSICAL_SCREEN_SIZE_Y - 1- PowerSpectrum[i>>1]*.5,
				 i+(eGFX_PHYSICAL_SCREEN_SIZE_X-256)/2, eGFX_RGB888_TO_RGB565(255,0,0));
			}
		     ...
		     eGFX_printf_Colored(&eGFX_BackBuffer,175,
												  ...
												  "FIT2017 - Audio Spectrum Analyzer");
