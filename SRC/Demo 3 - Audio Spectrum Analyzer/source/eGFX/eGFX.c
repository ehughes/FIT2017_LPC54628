...
eGFX_WEAK void eGFX_BitStreamPut(uint8_t * BitStream, uint32_t Position, uint32_t PixelState)
{
...
eGFX_WEAK uint32_t eGFX_BitStreamGet(uint8_t * BitStream, uint32_t Position)
{
...
eGFX_WEAK void eGFX_PutPixel(const eGFX_ImagePlane *Image,
                   int16_t x,
                   int16_t y,
                   eGFX_PixelState PS)
{
    ...
    if((x<Image->SizeX) && (y<Image->SizeY) && (x>=0) && (y>=0))
    {
        switch(Image->Type)
        {
            ...
            case  eGFX_IMAGE_PLANE_3BPP_RGB:
...
eGFX_WEAK eGFX_PixelState eGFX_GetPixel(const eGFX_ImagePlane *Image,
                         int16_t x,
                         int16_t y)
{
	uint32_t Offset = 0;
...
eGFX_WEAK void eGFX_DrawHline(eGFX_ImagePlane *Image,
                    int16_t XStart,
                    int16_t XStop,
                    int16_t Y,
                    eGFX_PixelState PS)
...
eGFX_WEAK void eGFX_DrawFilledBox(eGFX_ImagePlane *Image,
                        eGFX_Box *Box,
                        eGFX_PixelState PS)
{
    uint16_t i;
...
eGFX_WEAK void eGFX_DrawBox(eGFX_ImagePlane *Image,
                  eGFX_Box *Box,
                  eGFX_PixelState PS)
{
...
eGFX_WEAK void eGFX_DrawVline(eGFX_ImagePlane *Image,
                    int16_t YStart,
                    int16_t YStop,
                    int16_t X,
                    eGFX_PixelState PS)
...
eGFX_WEAK void eGFX_DrawLine(eGFX_ImagePlane *Image,
                   int16_t X1,
                   int16_t Y1,
                   int16_t X2,
                   int16_t Y2,
...
eGFX_WEAK void eGFX_DrawListPrimitive(eGFX_ImagePlane *Image,
...
eGFX_WEAK void eGFX_DrawScaledListPrimitive(eGFX_ImagePlane *Image,
                                  eGFX_ListPrimitive *LP ,
                                  FIXED_7_8 Scale,
                                  eGFX_PixelState PS)
{
...
eGFX_WEAK void eGFX_DrawScaledRotatedListPrimitive(eGFX_ImagePlane *Image,
        eGFX_ListPrimitive *LP ,
        uint8_t Angle,
        FIXED_7_8 Scale,
        eGFX_PixelState PS)
...
eGFX_WEAK void eGFX_DrawCircle(eGFX_ImagePlane *RC,
                     int16_t x0,
                     int16_t y0,
                     int16_t radius,
                     eGFX_PixelState PS)
...
eGFX_WEAK void eGFX_DrawFilledCircle(eGFX_ImagePlane *RC,
	int16_t x0,
	int16_t y0,
	int16_t radius,
	eGFX_PixelState PS)
...
eGFX_WEAK int16_t eGFX_ScaledDrawCharacter(eGFX_ImagePlane *Image,
								int16_t StartX,
								int16_t StartY,
								uint8_t Character,
...
eGFX_WEAK int16_t eGFX_DrawCharacter(eGFX_ImagePlane *Image,
	int16_t StartX,
	int16_t StartY,
	uint8_t Character,
	const eGFX_Font *MyFont)
...
eGFX_WEAK int16_t eGFX_DrawCharacterFaded(eGFX_ImagePlane *Image,
                           int16_t StartX,
                           int16_t StartY,
                           uint8_t Character,
                           const eGFX_Font *MyFont,
...
eGFX_WEAK int16_t eGFX_DrawCharacterColored(eGFX_ImagePlane *Image,
                           int16_t StartX,
                           int16_t StartY,
                           uint8_t Character,
                           const eGFX_Font *MyFont,
...
eGFX_WEAK int16_t eGFX_DrawCharacterShaded(eGFX_ImagePlane *Image,
	int16_t StartX,
	int16_t StartY,
	uint8_t Character,
	const eGFX_Font *MyFont,
...
eGFX_WEAK int16_t eGFX_GetStringWidth(char *String,
                            const eGFX_Font *MyFont)
{
    uint8_t Ptr = 0;
    uint8_t NextChar;
...
eGFX_WEAK int16_t eGFX_GetStringWidth_CustomSpacing(char *String,
        const eGFX_Font *MyFont,
        uint16_t Spacing)
{
    uint8_t Ptr = 0;
...
eGFX_WEAK void eGFX_DrawHorizontalCenteredString(eGFX_ImagePlane *Image,
										int16_t StartY,
										char *String,
										const eGFX_Font *MyFont)
{
...
eGFX_WEAK int16_t eGFX_DrawRightAlignedCenteredString_CustomSpacing(eGFX_ImagePlane *Image,
        int16_t StartY,
        char *String,
        const eGFX_Font *MyFont,
...
eGFX_WEAK void eGFX_DrawHorizontalCenteredString_CustomSpacing(eGFX_ImagePlane *Image,
        int16_t StartY,
        char *String,
        const eGFX_Font *MyFont,
        uint16_t Spacing)
...
eGFX_WEAK void eGFX_ScaledDrawString(eGFX_ImagePlane *Image,
	int16_t StartX,
	int16_t StartY,
	char *String,
	const eGFX_Font *MyFont,
...
eGFX_WEAK void eGFX_ScaledDrawString_CustomSpacing(eGFX_ImagePlane *Image,
	int16_t StartX,
	int16_t StartY,
	char *String,
	const eGFX_Font *MyFont,
...
eGFX_WEAK int16_t  eGFX_DrawString(eGFX_ImagePlane *Image,
	char *String,
	int16_t StartX,
	int16_t StartY,
...
eGFX_WEAK int16_t  eGFX_DrawStringShaded(eGFX_ImagePlane *Image,
	char *String,
	int16_t StartX,
	int16_t StartY,
	const eGFX_Font *MyFont,
...
eGFX_WEAK int16_t  eGFX_DrawStringColored(eGFX_ImagePlane *Image,
	char *String,
	int16_t StartX,
	int16_t StartY,
	const eGFX_Font *MyFont,
...
eGFX_WEAK int16_t  eGFX_printf(eGFX_ImagePlane *Image,
                     int16_t StartX,
                     int16_t StartY,
                     const eGFX_Font *MyFont,
                     char *FormatString,...)
...
eGFX_WEAK int16_t  eGFX_printf_Colored(eGFX_ImagePlane *Image,
                     int16_t StartX,
                     int16_t StartY,
                     const eGFX_Font *MyFont,
											uint32_t Color,
...
eGFX_WEAK int16_t  eGFX_printf_HorizontalCentered_Colored(eGFX_ImagePlane *Image,
                                         int16_t StartY,
                                        const eGFX_Font *MyFont,
                                        uint32_t Color,
                                        char *FormatString,...)
...
eGFX_WEAK int16_t eGFX_DrawString_CustomSpacing(eGFX_ImagePlane *Image,
                                      int16_t StartX,
                                      int16_t StartY,
                                      char *String,
                                      const eGFX_Font *MyFont,
...
eGFX_WEAK void eGFX_Blit(eGFX_ImagePlane *Destination,
	int16_t x,
	int16_t y,
...
eGFX_WEAK void eGFX_CenteredBlit(eGFX_ImagePlane *Destination,
	int16_t x,
	int16_t y,
	const eGFX_ImagePlane *Sprite)
{
...
//x,y is a the upper left corner of the blit, not the center
eGFX_WEAK void eGFX_BlitFaded(eGFX_ImagePlane *Destination,
               int16_t x,
               int16_t y,
               const eGFX_ImagePlane *Sprite,
               eGFX_PixelState PS)
...
//x,y is a the upper left corner of the blit, not the center
eGFX_WEAK void eGFX_BlitShaded(eGFX_ImagePlane *Destination,
	int16_t x,
	int16_t y,
	const eGFX_ImagePlane *Sprite,
	float Shading)
...
//x,y is a the upper left corner of the blit, not the center
eGFX_WEAK void eGFX_BlitColored(eGFX_ImagePlane *Destination,
	int16_t x,
	int16_t y,
	const eGFX_ImagePlane *Sprite,
	uint32_t Color)
...
eGFX_WEAK void eGFX_ScaledBlit(eGFX_ImagePlane *Destination,
					int16_t x,
					int16_t y,
					const eGFX_ImagePlane *Sprite,
					float ScaleFactor)
        ...
        for(i=0; i<DestinationSizeX; i++)
        {
			eGFX_PutPixel(Destination, 
							...
							eGFX_GetPixel(Sprite,
										 (int16_t)(SourcePixelX + 0.5f),
										 (int16_t)(SourcePixelY + 0.5f)
										 )
							);
...
eGFX_WEAK uint8_t eGFX_GetBitFromArray(uint8_t *DataArray,uint16_t Bit)
{
    uint8_t Mask;
    Mask = 1 << (7-(Bit&0x7));
...
eGFX_WEAK uint8_t eGFX_ImagePlane_GetByte(eGFX_ImagePlane   *Image,
                                uint16_t X,
                                uint16_t Y)
{
    uint32_t Offset;
...
eGFX_WEAK void eGFX_ImagePlane_Clear(eGFX_ImagePlane   *Image)
{
...
eGFX_WEAK FIXED_7_8 eGFX_GET_INT_FROM_FIXED_7_8_ROUND_TO_NEAREST(FIXED_7_8 A)
{
    FIXED_7_8 RetVal = 0;
...
eGFX_WEAK FIXED_7_8 eGFX_FLOAT_TO_FIXED_7_8(float A)
{
...
eGFX_WEAK int16_t eGFX_FMul_15_0to0_15(int16_t A, int16_t B)
{
    return  (((long)(A) * (long)(B))>>15);
}

eGFX_WEAK int16_t eGFX_FMul_7_8to0_15(int16_t A, int16_t B)
{
    return  (((long)(A) * (long)(B))>>15);
}

eGFX_WEAK int16_t eGFX_FMul_15_0to7_8(int16_t A,int16_t B)
{
    return  (((long)(A) * (long)(B))>>8);
}

eGFX_WEAK int16_t eGFX_FMul_15_0to1_14(int16_t A,int16_t B)
{
    long temp;
...
eGFX_WEAK int16_t eGFX_ABS(int16_t A)
{
    if(A<0)
        return -A;
    else
...
eGFX_WEAK void eGFX_ClearAnimators()
{
	eGFX_AnimatorEndIndex = 0;
}

eGFX_WEAK uint32_t eGFX_GetAnimatorCount()
{
	return eGFX_AnimatorEndIndex;
}

eGFX_WEAK uint32_t eGFX_AnimatorIsComplete(void * A)
{
	uint32_t RetVal = TRUE;

	if(((eGFX_ObjectHeader *)(A))->State == eGFX_OBJECT_STATE_ANIMATION_ACTIVE)
	{
		RetVal = FALSE;
	}
...
eGFX_WEAK uint32_t eGFX_AnimatorsAreComplete()
{
	uint32_t RetVal = TRUE;
	uint32_t i;
	...
	{
		if(eGFX_AnimatorIsComplete(eGFX_Animators[i]) == FALSE)
		{
			RetVal = FALSE;
			break;
		}
...
eGFX_WEAK void eGFX_PauseAnimator(void * A)
{
	((eGFX_AnimatorHeader *)(A))->State = eGFX_OBJECT_STATE_INACTIVE;
}

eGFX_WEAK void eGFX_StartAnimator(void * A)
{
	(*((eGFX_AnimatorHeader *)(A))).State = eGFX_OBJECT_STATE_ANIMATION_ACTIVE;
}

eGFX_WEAK void eGFX_ResetAnimator(void * A)
{

	eGFX_AnimatorHeader *AH = A;
	AH->State = eGFX_OBJECT_STATE_ANIMATION_ACTIVE;
	AH->CurrentStep= 0;
}

eGFX_WEAK void eGFX_ResetAnimators()
{
	for(int i=0;i<eGFX_AnimatorEndIndex;i++)
		{
    		 eGFX_ResetAnimator(eGFX_Animators[i]);
		}
}

eGFX_WEAK void eGFX_PauseAnimators()
{
	uint32_t i;
	...
	for (i = 0; i<eGFX_AnimatorEndIndex; i++)
	{
		if (eGFX_Animators[i]!=NULL)
			 eGFX_PauseAnimator(eGFX_Animators[i]);
	}

}

eGFX_WEAK void eGFX_StartAnimators()
{
	uint32_t i;
	...
	{
		if (eGFX_Animators[i] != NULL)
			eGFX_StartAnimator(&eGFX_Animators[i]);
	}
}
...
eGFX_WEAK uint32_t eGFX_InitPointF_BisectAnimator(eGFX_PointF_BisectAnimator *P,
								  eGFX_PointF Target,
								  eGFX_PointF *Current,
...
eGFX_WEAK uint32_t eGFX_AddPointF_BisectAnimator(eGFX_PointF_BisectAnimator *P,
									eGFX_PointF Target,
									eGFX_PointF *Current,
									uint32_t LastStep,			//Maximum Allow Steps before forced convergence
...
eGFX_WEAK void eGFX_ProcessPointF_BisectAnimator(eGFX_PointF_BisectAnimator *P)
{
...
//Initializes the data struct
eGFX_WEAK uint32_t eGFX_InitScalarF_BisectAnimator(eGFX_ScalarF_BisectAnimator *P,
	float Target,
	float *Current,
	uint32_t LastStep,			//Maximum Allow Steps before forced convergence
	float FractionalBisect) //The amount of percentage of the distance the point should move each step. Values <=0 or >= 1 are set to 0.5
...
//Initializes and adds a point bisect animator to the list.
//returns true if successful, false if not
eGFX_WEAK uint32_t eGFX_AddScalarF_BisectAnimator(eGFX_ScalarF_BisectAnimator *P,
	float Target,
	float *Current,
	uint32_t LastStep,			//Maximum Allow Steps before forced convergence
	float FractionalBisect) //The amount of percentage of the distance the point should move each step.   0 - 255 maps to 0 to 99.6%.   Zero is invalid
...
eGFX_WEAK void eGFX_ProcessScalarF_BisectAnimator(eGFX_ScalarF_BisectAnimator *P)
{
...
//Initializes the data struct
eGFX_WEAK uint32_t eGFX_InitScalarF_LinearAnimator(eGFX_ScalarF_LinearAnimator *P,
										float Target,
										float *Current,
										uint32_t LastStep,			//Maximum Allow Steps before forced convergence
										float Increment) 
...
//returns true if successful, false if not
eGFX_WEAK uint32_t eGFX_AddScalarF_LinearAnimator(eGFX_ScalarF_LinearAnimator *P,
	float Target,
	float *Current,
	uint32_t LastStep,			//Maximum Allow Steps before forced convergence
	float Increment) 
...
eGFX_WEAK void eGFX_ProcessScalarF_LinearAnimator(eGFX_ScalarF_LinearAnimator *P)
{
...
//Initializes the data struct
eGFX_WEAK uint32_t eGFX_InitPointF_LinearAnimator(eGFX_PointF_LinearAnimator *P,
	eGFX_PointF Target,
	eGFX_PointF *Current,
	uint32_t LastStep,			//Maximum Allow Steps before forced convergence
	float IncrementX,
...
//Initializes and adds a scalarf linear animator and adds it to the list
//returns true if successful, false if not
eGFX_WEAK uint32_t eGFX_AddPointF_LinearAnimator(eGFX_PointF_LinearAnimator *P,
	eGFX_PointF Target,
	eGFX_PointF *Current,
	uint32_t LastStep,			//Maximum Allow Steps before forced convergence
	float IncrementX,
...
eGFX_WEAK void eGFX_ProcessPointF_LinearAnimator(eGFX_PointF_LinearAnimator *P)
{
...
eGFX_WEAK void eGFX_ProcessAnimators()
{
	uint32_t i;
...
//Adds an animator object to the list.  returns TRUE if successful.
eGFX_WEAK uint32_t eGFX_AddObject(void * Object)
{
...
eGFX_WEAK void eGFX_DisableObject(void * Object)
{
	if(Object!=NULL)
	{
...
eGFX_WEAK void eGFX_InitObjectTextF(eGFX_Obj_TextF * TF,
...
eGFX_WEAK void eGFX_AddObjectTextF(eGFX_Obj_TextF * TF,
	eGFX_PointF Position,
	eGFX_Font *Font,
	char * String
	)
...
eGFX_WEAK void eGFX_InitObjectShadedTextF(eGFX_Obj_ShadedTextF * TF,
	eGFX_PointF Position,
	eGFX_Font *Font,
	char * String,
	float Shading
...
eGFX_WEAK void eGFX_AddObjectShadedTextF(eGFX_Obj_ShadedTextF * TF,
	eGFX_PointF Position,
	eGFX_Font *Font,
	char * String,
	float Shading
...
eGFX_WEAK void	eGFX_DrawObject_ShadedTextF(eGFX_ImagePlane * Image, eGFX_Obj_ShadedTextF *ShadedTextF_Object)
{
...
eGFX_WEAK void eGFX_InitObjectLineF(eGFX_Obj_LineF * LF,
	eGFX_PointF Start,
	eGFX_PointF End,
	eGFX_PixelState PS
	)
...
eGFX_WEAK void eGFX_AddObjectLineF(eGFX_Obj_LineF * LF,
	eGFX_PointF Start,
	eGFX_PointF End,
	eGFX_PixelState PS
	)
...
eGFX_WEAK void	eGFX_DrawObject_LineF(eGFX_ImagePlane * Image, eGFX_Obj_LineF *LineF_Object)
{
	eGFX_DrawLine(Image, 
...
eGFX_WEAK void eGFX_InitObjectSpriteF(eGFX_Obj_SpriteF * S,
							eGFX_PointF Position,
...
eGFX_WEAK void	eGFX_DrawObject_SpriteF(eGFX_ImagePlane * Image, eGFX_Obj_SpriteF *SpriteF_Object)
{
...
eGFX_WEAK void eGFX_AddObjectScaledSpriteF(eGFX_Obj_ScaledSpriteF * S,
	eGFX_PointF Position,
	eGFX_ImagePlane *	Sprite,
	float Scale
	)
...
eGFX_WEAK void	eGFX_DrawObject_ScaledSpriteF(eGFX_ImagePlane * Image, eGFX_Obj_ScaledSpriteF *SpriteF_Object)
{
...
eGFX_WEAK void eGFX_InitObjectCircleF(eGFX_Obj_CircleF * CF,
							eGFX_PointF Position,
							float Radius,
							eGFX_PixelState PS,
...
eGFX_WEAK void eGFX_AddObjectCircleF( eGFX_Obj_CircleF * CF,
							eGFX_PointF Position,
							float Radius,
							eGFX_PixelState PS,
							uint8_t CircleF_RenderOption
...
eGFX_WEAK void	eGFX_DrawObject_CircleF(eGFX_ImagePlane * Image, eGFX_Obj_CircleF *CircleF_Object)
{
...
eGFX_WEAK void eGFX_InitObjectBoxF(eGFX_Obj_BoxF * BF,
	eGFX_PointF P1,
	eGFX_PointF P2,
	eGFX_PixelState PS,
...
eGFX_WEAK void eGFX_AddObjectBoxF(eGFX_Obj_BoxF * BF,
	eGFX_PointF P1,
	eGFX_PointF P2,
	eGFX_PixelState PS,
	uint8_t BoxF_RenderOption
...
eGFX_WEAK void	eGFX_DrawObject_BoxF(eGFX_ImagePlane * Image, eGFX_Obj_BoxF *BoxF_Object)
{
	int16_t i;
	int16_t Start, End;
...
eGFX_WEAK void eGFX_DrawObjects(eGFX_ImagePlane *IP)
{
	uint32_t i;
